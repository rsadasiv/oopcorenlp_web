...
<script
    ...
    $(document).ready(function() {
		...
		showAggregateScores(annotation);
		...
		$('#annotators').change(
				function() {
			    	...
			    	showAggregateScores(annotation);
			    	makeAggregateBarChart(annotation, "#aggregateAnnotationViz");
			    	$('#subAnnotationScores').empty();
			    }
			);
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-4" id="aggregateScores"></div>
			<div class="col-lg-4"></div>
		</div>
		<div class="row">
			<div class="col-lg-12" id="aggregateViz">
				<svg width="1600" height="400" id="aggregateAnnotationViz"></svg>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-4"></div>
			<div class="col-lg-4" id="subAnnotationScores"></div>
			<div class="col-lg-4"></div>
		</div>					
	</div>
</body>
