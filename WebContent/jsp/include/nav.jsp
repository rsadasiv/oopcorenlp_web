		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="metadataMenuLink">
		   			<span class="dropdown-item">DocID: <%=request.getParameter("Document")%></span>
		   			<span class="dropdown-item">Title: <%=request.getAttribute("Title").toString()%></span>
		   			<span class="dropdown-item">Author: <%=request.getAttribute("Author").toString()%></span>
		   			<span class="dropdown-item">Date: <%=request.getAttribute("Date").toString()%></span> 
		 			<a class="dropdown-item" target="_viewer" href="GetDocumentScores?Corpus=<%=request.getParameter("Corpus")%>&Document=<%=request.getParameter("Document")%>&Scores=PIPELINE">Pipeline info</a>
				</div>
			</li>		
			<li class="nav-item dropdown">
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="analyzeMenuLink">
					...
					<a class="dropdown-item" target="_viewer" href="GetDocumentScores?Corpus=<%=request.getParameter("Corpus")%>&Document=<%=request.getParameter("Document")%>&Scores=OOP">OOPCoreNLP json</a>
					...
					<a class="dropdown-item" target="_viewer" href="GetDocumentScores?Corpus=<%=request.getParameter("Corpus")%>&Document=<%=request.getParameter("Document")%>&Scores=STANFORD">StanfordCoreNLP json</a>	
				</div>
			</li>												
		</ul>
	</div>
