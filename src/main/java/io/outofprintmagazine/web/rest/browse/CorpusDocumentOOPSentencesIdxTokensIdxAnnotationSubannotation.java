...
public class CorpusDocumentOOPSentencesIdxTokensIdxAnnotationSubannotation extends AbstractOOPCacheableServlet  {
			...
			) throws IOException, ServletException
    {
		...
		if (oop.hasNonNull("sentences")) {
			...
			if (tokensNode.get(tokenIdx.intValue()).hasNonNull(annotation)) {
