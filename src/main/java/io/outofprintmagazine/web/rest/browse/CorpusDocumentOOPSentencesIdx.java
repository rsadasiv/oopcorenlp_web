...
@Path("/Corpora/{Corpus}/{Document}/OOP/sentences/{SentenceIdx}")
public class CorpusDocumentOOPSentencesIdx extends AbstractOOPCacheableServlet  {
			...
			) throws IOException, ServletException
    {
		...
		if (oop.hasNonNull("sentences")) {
			...
			retval = (ObjectNode) sentencesNode.get(idx.intValue());
		}
