...
@WebServlet("/OOPCorpusCVScoresViewer")
public class OOPCorpusCVScoresViewer extends AbstractOOPServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OOPCorpusCVScoresViewer() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().getServletContext().getRequestDispatcher("/jsp/OOPCorpusCVScoresViewer.jsp").forward(request, response);
	}
}
