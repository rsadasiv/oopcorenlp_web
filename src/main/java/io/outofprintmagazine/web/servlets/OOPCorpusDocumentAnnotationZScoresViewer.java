...
@WebServlet("/OOPCorpusDocumentAnnotationZScoresViewer")
public class OOPCorpusDocumentAnnotationZScoresViewer extends AbstractOOPServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OOPCorpusDocumentAnnotationZScoresViewer() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().getServletContext().getRequestDispatcher("/jsp/OOPCorpusDocumentAnnotationZScoresViewer.jsp").forward(request, response);
	}
}
