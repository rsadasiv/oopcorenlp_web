...
@WebServlet("/OOPCorpusDocumentAnnotationTfidfViewer")
public class OOPCorpusDocumentAnnotationTfidfViewer extends AbstractOOPServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OOPCorpusDocumentAnnotationTfidfViewer() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().getServletContext().getRequestDispatcher("/jsp/OOPCorpusDocumentAnnotationTfidfViewer.jsp").forward(request, response);
	}
}
